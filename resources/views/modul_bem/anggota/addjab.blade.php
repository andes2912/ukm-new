<div class="modal fade" id="tampiljab" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                ...
                <form>
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="nam" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="form-group">
